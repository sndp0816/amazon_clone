...
import 'package:amazon_clone_app/features/search/services/search_service.dart';
import 'package:amazon_clone_app/features/search/widgets/search_product.dart';
...
class _SearchScreenState extends State<SearchScreen> {
  ...
  fetchSearchedProduct() async {
    products = await searchService.fetchSeachedProducts(
